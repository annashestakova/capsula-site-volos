...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    description: "Почему биопротеин — лучший выбор для пористых волос. Не требует кератинового ламинирования.",
    date: "2025-04-18",
    tag: "Биопротеин",
    readTime: "4 мин",
    popular: true,
  ...
  },
  {
    ...
    description: "Коррекция раз в 2–2,5 месяца — не расход, а забота о волосах. От 160 BYN.",
    date: "2025-05-05",
    tag: "Уход",
    readTime: "4 мин",
    popular: false,
  },
  {
    ...
    description: "Загущение биопротеиновыми волосами даёт потрясающий эффект за меньшие деньги.",
    date: "2025-05-10",
    tag: "Загущение",
    readTime: "3 мин",
    popular: false,
  },
  {
    ...
    description: "Какие шампуни нельзя, как расчёсывать, спать, мыть голову — всё для максимального срока.",
    date: "2025-05-12",
    tag: "Уход",
    readTime: "7 мин",
    popular: true,
  },
  {
    ...
    description: "Почему я работаю только с натуральным волосом — про текстуру, блеск и срок службы.",
    date: "2025-05-14",
    tag: "О волосах",
    readTime: "5 мин",
    popular: false,
  },
  {
    ...
    description: "Разбираю какой метод подходит для тонких волос и почему биопротеин здесь в плюсе.",
    date: "2025-05-15",
    tag: "Капсульное",
    readTime: "4 мин",
    popular: false,
    ...
    <main className="min-h-screen bg-[#FAF7F2] dark:bg-[#1a1210] pt-24 md:pt-28 pb-20 px-4">
      ...
      >
        ...
        <p className="mt-4 font-[Jost] text-[#3D2B1F]/60 dark:text-[#FAF7F2]/60 max-w-md mx-auto">
          Отвечаю на самые частые вопросы — честно, без воды
        </p>
      </motion.div>
